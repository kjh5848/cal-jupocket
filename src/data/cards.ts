...
export const cardSets: CardSet[] = [
  ...
  },
  {
    slug: "vat-prepayment",
    cluster: "vat",
    link: "https://jupocket.com/guide/vat-prepayment/",
    cards: [
      {
        kind: "cover",
        photo: "/photos/card-letterslot.jpg",
        photoAlt: "어두운 색 나무문에 놋쇠 우편 투입구가 달려 있다",
        badge: "부가가치세",
        title: "매출이 꺾였으면\n고지서대로 안 내도 됩니다",
        sub: "직전 과세기간의 3분의 1에 미달하면 예정신고로 바꿔 실제 금액만 냅니다. 2기분은 10월 25일까지입니다.",
        footnote: "부가가치세법 제48조 제4항 · 시행령 제90조 제6항",
      },
      {
        kind: "table",
        title: "10월에 누가 무엇을 하나",
        sub: "신고냐 고지냐가 여기서 갈린다",
        rows: [
          { label: "개인사업자 (일반과세)", value: "예정고지", tone: "mark" },
          { label: "법인 — 직전 공급가액 1.5억 미만", value: "예정고지", tone: "mark" },
          { label: "법인 — 직전 공급가액 1.5억 이상", value: "예정신고" },
          { label: "간이과세자", value: "해당 없음" },
        ],
        footnote:
          "부가가치세법 제48조 제1항·제3항 · 시행령 제90조 제4항 · 출처 국가법령정보센터",
      },
      {
        kind: "table",
        title: "얼마가 찍히나",
        sub: "직전 과세기간 납부세액 × 50% · 1천원 미만 버림",
        rows: [
          { label: "직전 90만원 → 45만원", value: "고지서 없음", tone: "mark" },
          { label: "직전 100만원 → 50만원", value: "여기가 경계", tone: "warn" },
          { label: "직전 155만 5천원", value: "77만 7천원" },
          { label: "직전 420만원", value: "210만원" },
        ],
        footnote:
          "제48조 제3항 · 155만 5천원의 절반은 77만 7,500원인데 1천원 미만을 버린다",
      },
      {
        kind: "list",
        badge: "고지서가 안 나오는 경우",
        ...
        items: [
          {
            ...
            detail: "직전 과세기간 납부세액으로는 100만원이 경계다",
          },
          {
            text: "간이과세자에서 [[일반과세자로 변경]]",
            detail: "해당 과세기간 개시일 현재를 기준으로 본다",
          },
          {
            text: "국세징수법 제13조 제1항의 사유로 {{납부할 수 없다고 인정}}",
            detail: "관할 세무서장이 인정하는 경우",
          },
          {
            text: "다만 {{확정신고는 그대로 합니다}}",
            detail: "예정고지는 미리 나눠 내는 장치이지 세금을 깎지 않는다",
          },
        ],
        footnote: "부가가치세법 제48조 제3항 단서 · 출처 국가법령정보센터",
      },
      {
        kind: "table",
        title: "언제 오고 언제까지 내나",
        sub: "고지서 발부기간은 시행령이 따로 정한다",
        rows: [
          { label: "제1기 — 1월 1일~3월 31일", value: "4월 25일" },
          { label: "고지서 발부", value: "4월 1~10일" },
          { label: "제2기 — 7월 1일~9월 30일", value: "10월 25일", tone: "mark" },
          { label: "고지서 발부", value: "10월 1~10일", tone: "mark" },
        ],
        footnote: "법 제48조 제1항 표 · 시행령 제90조 제5항 표 · 출처 국가법령정보센터",
      },
      {
        kind: "note",
        badge: "미납 가산세를 묻는 분께",
        title: "이 금액은 저희도 확정하지 못했습니다",
        body:
          "시행령 제90조 제1항은 예정[[신고]]·납부에 국세기본법 제47조의2~4를 적용하지 않는다고만 하고, 제3항의 예정[[고지]]세액을 안 냈을 때를 다루지 않습니다.\n\n{{조문 세 개를 이어 추론하면 숫자가 나오지만 그것은 확인한 값이 아닙니다.}}\n\n고지서에 적힌 금액과 기한을 먼저 보세요.",
        footnote: "국세기본법 제47조의4 제1항·제8항 · 국세상담센터 126",
      },
      {
        kind: "cta",
        title: "우리는\n얼마가 나오나?",
        sub: "대상·금액·기한과 예정신고로 갈아타는 두 경우를 글에 정리했어요",
        refNo: 32,
      },
    ],
  },
